function cat12_slice_and_dice_all_job(nyrs)
%-----------------------------------------------------------------------
% Job saved on 09-Nov-2020 12:54:55 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
addpath(genpath('/home/mfromano/spm/spm12/'));

% BASE_DIR = '/data2/MRI_PET_DATA/processed_images_final/';
% AMYLOID_folder_new = [BASE_DIR 'ADNI_PET_nii_recenter/'];
% MRI_folder_new = [BASE_DIR 'ADNI_MRI_nii_recenter/'];
% FDG_folder_new = [BASE_DIR 'ADNI_FDG_nii_recenter/'];
% 
% txt_folder = [BASE_DIR 'batch_jobs/'];
% 
...
rand('state',10);
newdir = ['/data2/MRI_PET_DATA/processed_images_final' nyrs '/ADNI_MRI_nii_recentered_cat12' nyrs];
mkdir(newdir);
